<?php
 ...
 <div class="container">
			<div class="row">
				<div class="col-sm-12">
					<span class="text-white p-3"><strong>ORDER HISTORY</strong><strong class="float-right">TOTAL ORDERS: <?php echo $total_orders; ?></strong></span>
						<br>
						<div class="details  p-3" >
							...
							<?php 
							 ...
							 <div id="data"></div>
							 <div id="loading"></div>
							 <div id="order_info" class="text-white"></div>
							<form method="post">
